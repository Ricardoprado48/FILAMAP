...
// 1. Gera o código OpenSCAD paramétrico do Clipe com Berço NFC
const scadCode = `
$fn = 90;
...
fs.writeFileSync("C:\\FILAMAP\\clipe_nfc_filamap.scad", scadCode, "utf8");
console.log("✅ Arquivo OpenSCAD criado em C:\\FILAMAP\\clipe_nfc_filamap.scad");

// Converte para STL se o OpenSCAD estiver instalado no sistema
const openscadPaths = [
    "C:\\Program Files\\OpenSCAD\\openscad.exe",
    "C:\\Program Files (x86)\\OpenSCAD\\openscad.exe"
];
let bin = openscadPaths.find(p => fs.existsSync(p));

if (bin) {
    console.log("⚙️ Compilando STL via OpenSCAD...");
    execSync(`"${bin}" -o "C:\\FILAMAP\\clipe_nfc_filamap.stl" "C:\\FILAMAP\\clipe_nfc_filamap.scad"`);
    console.log("🎉 Arquivo STL gerado com sucesso: C:\\FILAMAP\\clipe_nfc_filamap.stl");
} else {
    console.log("ℹ️ OpenSCAD não detectado no caminho padrão. O arquivo .scad está pronto para abrir e exportar.");
}